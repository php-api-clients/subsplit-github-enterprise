# [READONLY-SUBSPLIT] github-enterprise-enterprise-admin
...
Non-Blocking first GitHub Enterprise (v3.5) enterprise-admin client, this is a read only sub split, see [`root-subsplit-github`](https://github.com/php-api-clients/root-subsplit-github).
