...
final class UpdateUsernameForUser
{
     ...
     */
    function createResponse(\Psr\Http\Message\ResponseInterface $response) : Schema\Operation\EnterpriseAdmin\UpdateUsernameForUser\Response\Applicationjson\H202
    {
