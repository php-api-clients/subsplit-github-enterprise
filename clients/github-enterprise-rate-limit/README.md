# [READONLY-SUBSPLIT] github-enterprise-rate-limit
...
Non-Blocking first GitHub Enterprise (v3.4) rate-limit client, this is a read only sub split, see [`root-subsplit-github`](https://github.com/php-api-clients/root-subsplit-github).
