# [READONLY-SUBSPLIT] github-enterprise-repos
...
Non-Blocking first GitHub Enterprise (v3.6) repos client, this is a read only sub split, see [`root-subsplit-github`](https://github.com/php-api-clients/root-subsplit-github).
