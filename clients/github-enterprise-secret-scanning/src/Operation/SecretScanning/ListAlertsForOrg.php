...
final class ListAlertsForOrg
{
    ...
    {
        return new \RingCentral\Psr7\Request(self::METHOD, \str_replace(array('{org}', '{state}', '{secret_type}', '{resolution}', '{page}', '{per_page}'), array($this->org, $this->state, $this->secretType, $this->resolution, $this->page, $this->perPage), self::PATH . '?state={state}&secretType={secret_type}&resolution={resolution}&page={page}&perPage={per_page}'));
    }
    /**
