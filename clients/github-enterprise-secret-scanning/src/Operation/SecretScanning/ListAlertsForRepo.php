...
final class ListAlertsForRepo
{
    ...
    {
        return new \RingCentral\Psr7\Request(self::METHOD, \str_replace(array('{owner}', '{repo}', '{state}', '{secret_type}', '{resolution}', '{sort}', '{direction}', '{page}', '{per_page}'), array($this->owner, $this->repo, $this->state, $this->secretType, $this->resolution, $this->sort, $this->direction, $this->page, $this->perPage), self::PATH . '?state={state}&secretType={secret_type}&resolution={resolution}&sort={sort}&direction={direction}&page={page}&perPage={per_page}'));
    }
    /**
