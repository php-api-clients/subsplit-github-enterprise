# [READONLY-SUBSPLIT] github-enterprise-secret-scanning
...
Non-Blocking first GitHub Enterprise (v3.6) secret-scanning client, this is a read only sub split, see [`root-subsplit-github`](https://github.com/php-api-clients/root-subsplit-github).
