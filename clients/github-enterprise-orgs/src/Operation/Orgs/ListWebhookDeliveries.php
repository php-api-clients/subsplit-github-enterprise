...
final class ListWebhookDeliveries
{
    ...
    {
        return new \RingCentral\Psr7\Request(self::METHOD, \str_replace(array('{org}', '{hook_id}', '{cursor}', '{per_page}'), array($this->org, $this->hookId, $this->cursor, $this->perPage), self::PATH . '?cursor={cursor}&perPage={per_page}'));
    }
    /**
