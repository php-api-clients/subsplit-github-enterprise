# [READONLY-SUBSPLIT] github-enterprise-oauth-authorizations
...
Non-Blocking first GitHub Enterprise (v3.7) oauth-authorizations client, this is a read only sub split, see [`root-subsplit-github`](https://github.com/php-api-clients/root-subsplit-github).
