# [READONLY-SUBSPLIT] github-enterprise-apps
...
Non-Blocking first GitHub Enterprise (v3.0) apps client, this is a read only sub split, see [`root-subsplit-github`](https://github.com/php-api-clients/root-subsplit-github).
