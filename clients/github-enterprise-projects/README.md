# [READONLY-SUBSPLIT] github-enterprise-projects
...
Non-Blocking first GitHub Enterprise (v3.8) projects client, this is a read only sub split, see [`root-subsplit-github`](https://github.com/php-api-clients/root-subsplit-github).
