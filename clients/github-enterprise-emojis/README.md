# [READONLY-SUBSPLIT] github-enterprise-emojis
...
Non-Blocking first GitHub Enterprise (v3.1) emojis client, this is a read only sub split, see [`root-subsplit-github`](https://github.com/php-api-clients/root-subsplit-github).
