...
[![Code Coverage](https://scrutinizer-ci.com/g/php-api-clients/github-enterprise/badges/coverage.png?b==v0.2.3.8.x)](https://scrutinizer-ci.com/g/php-api-clients/github-enterprise/?branch=v0.2.3.8.x)
...
Non-Blocking first GitHub Enterprise (v3.8) client, this is a read only sub split, see [`root-subsplit-github`](https://github.com/php-api-clients/github-root).
